...
\setlength{\parindent}{2.5ex}
This can be observed in the Arducam.C file, in any of the functions that use the Write\_SPI() function. A packet of 2 bytes is built and then placed into the TX of the PSoC 6 for transfer, which is handle by Write\_SPI(). These functions are: \\
